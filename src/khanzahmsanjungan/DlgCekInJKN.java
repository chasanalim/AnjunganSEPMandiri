 ...
 * @author Kode
 */
public class DlgCekInJKN extends javax.swing.JDialog {

    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private validasi Valid = new validasi();
    private PreparedStatement ps, ps3,psbook;
    private ResultSet rs, rs3,rsbook;
     ...
     * @param id
     */
    public DlgCekInJKN(java.awt.Frame parent, boolean id) {
        super(parent, id);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblNoBooking = new component.Label();
        jLabel37 = new component.Label();
        lblKodeBooking = new component.Label();
        jLabel38 = new component.Label();
        jPanel3 = new javax.swing.JPanel();
        btnSimpan = new component.Button();
        btnBack = new component.Button();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 215, 255)), "CEK IN PESERTA MOBILE JKN", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Poppins", 0, 24), new java.awt.Color(0, 131, 62))); // NOI18N
        ...
        jLabel10.setBounds(20, 80, 250, 40);
        ...
        jLabel11.setBounds(270, 90, 20, 23);
        ...
        lblNamaPasien.setBounds(380, 80, 410, 40);
        ...
        jLabel28.setBounds(270, 130, 20, 23);
        ...
        jLabel29.setBounds(20, 120, 250, 40);
        ...
        jLabel30.setBounds(270, 180, 20, 23);
        ...
        jLabel31.setBounds(20, 170, 250, 40);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2023" }));
        ...
        TanggalPeriksa.setBounds(290, 120, 190, 40);
        ...
        jPanel2.add(lblNoRM);
        lblNoRM.setBounds(290, 80, 90, 40);
        ...
        jLabel32.setBounds(20, 210, 250, 40);
        ...
        jLabel33.setBounds(270, 220, 20, 23);
        ...
        jLabel35.setBounds(270, 260, 20, 23);
        ...
        NamaDokter.setBounds(290, 210, 520, 40);

        lblNoBooking.setBackground(new java.awt.Color(255, 102, 102));
        lblNoBooking.setForeground(new java.awt.Color(0, 131, 62));
        lblNoBooking.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblNoBooking.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        lblNoBooking.setPreferredSize(new java.awt.Dimension(20, 14));
        jPanel2.add(lblNoBooking);
        lblNoBooking.setBounds(290, 250, 170, 40);

        jLabel37.setForeground(new java.awt.Color(0, 131, 62));
        jLabel37.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel37.setText("Nomor / Kode Booking");
        jLabel37.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        jLabel37.setPreferredSize(new java.awt.Dimension(20, 14));
        jPanel2.add(jLabel37);
        jLabel37.setBounds(20, 40, 250, 40);

        lblKodeBooking.setBackground(new java.awt.Color(255, 102, 102));
        lblKodeBooking.setForeground(new java.awt.Color(0, 131, 62));
        lblKodeBooking.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblKodeBooking.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        lblKodeBooking.setPreferredSize(new java.awt.Dimension(20, 14));
        jPanel2.add(lblKodeBooking);
        lblKodeBooking.setBounds(290, 40, 250, 40);
        ...
        jLabel38.setBounds(270, 50, 20, 23);
        ...
        btnSimpan.setText("Konfirmasi Check In");
        ...
        btnBack.setForeground(new java.awt.Color(0, 131, 62));
        btnBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/logout.png"))); // NOI18N
        btnBack.setMnemonic('S');
        btnBack.setText("Kembali");
        btnBack.setToolTipText("Alt+S");
        btnBack.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        btnBack.setGlassColor(new java.awt.Color(255, 153, 102));
        btnBack.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        btnBack.setPreferredSize(new java.awt.Dimension(300, 45));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (lblNoRM.getText().equals("")) {
            ...
            if(Sequel.mengedittf("referensi_mobilejkn_bpjs","nobooking=?","status='Checkin',validasi=now()",1,new String[]{
                  lblKodeBooking.getText()
              })==true) {
                Sequel.meghapus("referensi_mobilejkn_bpjs_batal","nobooking",lblKodeBooking.getText());
               
                NamaPoli.setText("");
                NamaDokter.setText("");
                lblNoRM.setText("");
                lblNamaPasien.setText("");
                lblNoBooking.setText("");
                NamaDokter.setText("");
...
//        poli.setVisible(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCekInJKN dialog = new DlgCekInJKN(new javax.swing.JFrame(), true);
    ...
    private component.Button btnBack;
    ...
    private component.Label lblKodeBooking;
    private component.Label lblNamaPasien;
    private component.Label lblNoBooking;
...
//                psbook.setString(1, kodebooking);
                ...
                while (rsbook.next()) {
                    lblKodeBooking.setText(rsbook.getString("nobooking"));
                    lblNoRM.setText(rsbook.getString("no_rkm_medis"));
                    lblNamaPasien.setText(rsbook.getString("nm_pasien"));
                    lblNoBooking.setText(rsbook.getString("nomorantrean"));
                    NamaPoli.setText(rsbook.getString("nm_poli"));
                    NamaDokter.setText(rsbook.getString("nm_dokter_bpjs"));
//                    Valid.SetTgl(TanggalPeriksa.getSelectedItem().toString());
//                    TanggalPeriksa.setString(Valid.SetTgl(TanggalPeriksa.getSelectedItem().toString()));
